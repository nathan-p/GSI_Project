Public Class Article
    ...
    '*************************** Constructeur     ***********************************
    '********************************************************************************
    Public Sub New(ByVal name As String, ByVal brand As String, ByVal price As Double, ByVal weight As Double, Optional ByVal origin As String = "France", Optional ByVal desc As String = "Aucune description.", Optional ByVal img As String = "")
